...
#define DEF_MAX_CPU_LOCK			(1600000)
#define DEF_MIN_CPU_LOCK			(254000)
...
#define FREQ_FOR_RESPONSIVENESS			(765000)
/* for fast decrease */
#define UP_THRESHOLD_AT_FAST_DOWN		(95)
#define FREQ_FOR_FAST_DOWN			(565000)

#define HOTPLUG_DOWN_INDEX			(0)
#define HOTPLUG_UP_INDEX			(1)

#ifdef CONFIG_CPU_FREQ_GOV_ONDEMAND_FLEXRATE
#define FLEX_MAX_FREQ				(765000)
#endif

#ifdef CONFIG_CPU_FREQ_LCD_FREQ_DFS
#define LCD_FREQ_KICK_IN_DOWN_DELAY		(20)
#define LCD_FREQ_KICK_IN_FREQ			(565000)
